...
- **No prompt cancel** — receipt settlement is correlated, but the wire has no targeted cancellation method; abandoning a submission means closing the runtime.
