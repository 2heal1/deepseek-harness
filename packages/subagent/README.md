...
| [`subagent-runtime-route/`](subagent-runtime-route/README.md) | Maintains Runtime Profile-backed one-shot providers and delegation tools | `ctx.agentRuntimeSubagentRoutes` |
