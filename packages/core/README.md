...
| [`agent-runtime-acp/`](agent-runtime-acp/README.md) | ACP protocol-v1 one-shot runtime Provider | registers with `ctx.agentRuntimes` |
| [`agent-runtime-codex/`](agent-runtime-codex/README.md) | Codex App Server runtime Provider | registers with `ctx.agentRuntimes` |
