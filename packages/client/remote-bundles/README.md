...
- [DSH Bundle Builder](../../bundle/bundle-builder/README.md) — produces the browser remote this package consumes.
...
- **One client export per remote Bundle** — the container must expose the Builder's fixed `./client` module.
