...
| [`core/agent-runtime-launcher`](../packages/core/agent-runtime-launcher/README.md) | Secure external-runtime process launch and teardown | `ctx.agentRuntimeLauncher` |
