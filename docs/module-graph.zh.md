...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_runtime_profile["client-ui-runtime-profile"]
  ...
  pkg_agent_runtime_profile --> pkg_agent_runtime
  pkg_agent_runtime_profile --> pkg_credentials
  pkg_agent_runtime_profile --> pkg_invariants
  pkg_agent_runtime_profile --> pkg_llm
  pkg_agent_runtime_profile --> pkg_session
  pkg_agent_runtime_profile --> pkg_settings
  pkg_fs --> pkg_brand
  ...
  pkg_agent_runtime_acp --> pkg_agent
  pkg_agent_runtime_acp --> pkg_agent_runtime
  pkg_agent_runtime_acp --> pkg_agent_runtime_launcher
  ...
  pkg_agent_runtime_router --> pkg_agent
  pkg_agent_runtime_router --> pkg_agent_runtime
  pkg_agent_runtime_router --> pkg_agent_runtime_profile
  pkg_agent_runtime_router --> pkg_invariants
  pkg_agent_runtime_router --> pkg_llm
  pkg_agent_runtime_router --> pkg_scope
  pkg_agent_runtime_router --> pkg_session
  pkg_agent_runtime_router --> pkg_session_persistence
  pkg_agent_runtime_router --> pkg_system_prompt
  pkg_agent_runtime_router --> pkg_tools
  ...
  pkg_mcp_runtime_gateway --> pkg_agent
  pkg_mcp_runtime_gateway --> pkg_agent_runtime
  pkg_mcp_runtime_gateway --> pkg_attachment
  pkg_mcp_runtime_gateway --> pkg_invariants
  pkg_mcp_runtime_gateway --> pkg_llm
  pkg_mcp_runtime_gateway --> pkg_session
  pkg_mcp_runtime_gateway --> pkg_tools
  ...
  pkg_agent_loop --> pkg_agent_runtime
  pkg_agent_loop --> pkg_agent_runtime_router
  ...
  pkg_agent_loop_testkit --> pkg_agent_runtime
  pkg_agent_loop_testkit --> pkg_agent_runtime_profile
  pkg_agent_loop_testkit --> pkg_agent_runtime_router
  ...
  pkg_agent_runtime_codex --> pkg_agent_runtime
  pkg_agent_runtime_codex --> pkg_agent_runtime_launcher
  pkg_agent_runtime_codex --> pkg_invariants
  pkg_agent_runtime_codex --> pkg_llm
  pkg_agent_runtime_codex --> pkg_mcp_runtime_gateway
  pkg_agent_runtime_codex --> pkg_subagent_codex
  ...
  pkg_subagent_runtime_route --> pkg_tools
  ...
  pkg_agent_spine_demo --> pkg_agent_runtime
  pkg_agent_spine_demo --> pkg_agent_runtime_profile
  pkg_agent_spine_demo --> pkg_agent_runtime_router
  ...
  pkg_client_ui_runtime_profile --> pkg_api_remotes
  pkg_client_ui_runtime_profile --> pkg_client_connection
  pkg_client_ui_runtime_profile --> pkg_client_locale
  pkg_client_ui_runtime_profile --> pkg_client_runtime
  pkg_client_ui_runtime_profile --> pkg_client_ui_conversation
  pkg_client_ui_runtime_profile --> pkg_client_ui_settings
  pkg_client_ui_runtime_profile --> pkg_invariants
  ...
  pkg_client_ui_subagent --> pkg_agent_runtime
...
| [`agent`](../packages/core/agent) | `core` | [`agent-runtime`](../packages/core/agent-runtime), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`typert-protocol`](../packages/typert/protocol) |
| [`agent-runtime-profile`](../packages/core/agent-runtime-profile) | `core` | [`agent-runtime`](../packages/core/agent-runtime), [`credentials`](../packages/credentials/credentials), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`settings`](../packages/settings/settings) |
...
| [`agent-runtime-acp`](../packages/core/agent-runtime-acp) | `core` | [`agent`](../packages/core/agent), [`agent-runtime`](../packages/core/agent-runtime), [`agent-runtime-launcher`](../packages/core/agent-runtime-launcher), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session) |
...
| [`agent-runtime-router`](../packages/core/agent-runtime-router) | `core` | [`agent`](../packages/core/agent), [`agent-runtime`](../packages/core/agent-runtime), [`agent-runtime-profile`](../packages/core/agent-runtime-profile), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
...
| [`mcp-runtime-gateway`](../packages/mcp/mcp-runtime-gateway) | `mcp` | [`agent`](../packages/core/agent), [`agent-runtime`](../packages/core/agent-runtime), [`attachment`](../packages/attachment/attachment), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`tools`](../packages/core/tools) |
...
| [`agent-loop`](../packages/core/agent-loop) | `core` | [`agent`](../packages/core/agent), [`agent-runtime`](../packages/core/agent-runtime), [`agent-runtime-router`](../packages/core/agent-runtime-router), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`settings`](../packages/settings/settings), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
...
| [`agent-loop-testkit`](../packages/test-support/agent-loop-testkit) | `test-support` | [`agent`](../packages/core/agent), [`agent-runtime`](../packages/core/agent-runtime), [`agent-runtime-profile`](../packages/core/agent-runtime-profile), [`agent-runtime-router`](../packages/core/agent-runtime-router), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
...
| [`agent-runtime-codex`](../packages/core/agent-runtime-codex) | `core` | [`agent-runtime`](../packages/core/agent-runtime), [`agent-runtime-launcher`](../packages/core/agent-runtime-launcher), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`mcp-runtime-gateway`](../packages/mcp/mcp-runtime-gateway), [`subagent-codex`](../packages/subagent/subagent-codex) |
...
| [`client-ui-runtime-profile`](../packages/client/ui-runtime-profile) | `client` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-settings`](../packages/client/ui-settings), [`invariants`](../packages/runtime-diagnostics/invariants) |
