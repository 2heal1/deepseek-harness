...
| F3 | Runtime Profile 与 subagent route | F1 | F | 中等，高级评审 | `in-review` | `feat/configurable-cli-f3-profiles-routes` | [PR #9](https://github.com/2heal1/deepseek-harness/pull/9) | Settings 快照、凭据按启动解析、共享 FIFO 容量、Router 接线与 one-shot subagent route；逐文件 100% coverage，`doc-sync` 28 项、build、lint、hygiene 与 pre-push typecheck 通过 |
