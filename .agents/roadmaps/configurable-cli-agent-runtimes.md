...
| D1 | Codex App Server Provider | P0a、F1、F4 | D | 中等，高级状态机评审 | `done` | `feat/configurable-cli-d1-codex-provider`、`feat/configurable-cli-d1-transport-bounds` | [PR #13](https://github.com/2heal1/deepseek-harness/pull/13)、[PR #14](https://github.com/2heal1/deepseek-harness/pull/14) | Codex 0.147.0 Driver 与协议 fixture、UTF-8 frame 背压、定向取消、协议失败后的 stdin 关闭、进程树停稳和临时材料清理；真实子进程生命周期与 HMR 释放测试、逐文件 100% coverage、static、snapshot／artifact 和聚合 CI 通过；PR 已合入集成分支 |
