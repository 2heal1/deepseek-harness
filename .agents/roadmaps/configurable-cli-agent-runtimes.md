...
| F1 | agent 运行时 Service Definition | P1 | F1 | 高级 | `in-review` | `feat/configurable-cli-f1-runtime-service` | [PR #7](https://github.com/2heal1/deepseek-harness/pull/7) | 类型、Fake Provider、能力与失败测试、不变量配套工具 |
