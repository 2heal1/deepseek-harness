...
| D2 | ACP 一次性 Provider | P0b、F1、F4 | D | 中等，高级状态机评审 | `in-progress` | `feat/configurable-cli-d2-acp-provider` | — | Fixture 一致性、一次性结果、取消与失败清理；补充 Driver 启动 argv 与保留参数拒绝 fixture |
