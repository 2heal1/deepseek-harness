...
远端状态：P0a、P0b、P0c、P1、F1、F2、F3、F4、F5、D1、D2、U1 已合入 `fork/feat/configurable-cli`
...
| M1 | 外部主 agent 垂直切片 | F2、F3、F5、D1 | M | 高级 | `in-review` | `feat/configurable-cli-m1-main-agent` | [PR #20](https://github.com/2heal1/deepseek-harness/pull/20) | Codex Optional Profile Bundle、外部 Session identity、串行 submission、流、receipt、定向取消、turn activity、固定 Profile 与进程停稳；Codex Provider／wire 77 项逐文件 100% coverage，Router 32 项、Host Preset 41 项及真实 Loader snapshot 通过，`doc-sync` 28 项、build、typecheck、lint 与 hygiene 通过 |
