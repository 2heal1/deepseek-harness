...
| F5 | 会话事件与 Host API | F1、P0c | F | 高级 | `in-review` | `feat/configurable-cli-f5-events-host-api` | [PR #11](https://github.com/2heal1/deepseek-harness/pull/11) | Projection、fork、来源、不支持能力与 API schema 测试 |
