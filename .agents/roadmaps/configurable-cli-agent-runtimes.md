...
| G1 | 每会话 MCP 网关 | M1、S1 | G | 高级安全所有者 | `in-review` | `feat/configurable-cli-g1-mcp-gateway` | [PR #22](https://github.com/2heal1/deepseek-harness/pull/22) | 发现与执行器授权、审批、取消与审计测试 |
