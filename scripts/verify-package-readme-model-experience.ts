...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-runtime-profile': { kind: 'indirect', reason: 'Selection routes session.create with a Runtime Profile id; the Host and Router own the pinned snapshot and every model-visible effect.' },
  ...
  'packages/core/agent-runtime-launcher': { kind: 'none', reason: 'The process launcher contributes no model request content.' },
