...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/remote-bundles': { kind: 'none', reason: 'Browser and Host delivery machinery; only the loaded Bundle plugins can affect model input.' },
  ...
  'packages/bundle/bundle-builder': { kind: 'none', reason: 'Build-time artifact tooling; emitted Bundle plugins own every model-facing effect.' },
