...
const MANIFEST_BIN_ALLOWLIST = new Map<string, ManifestBin>([
  ...
  ['packages/bundle/bundle-builder/package.json', { 'dsh-bundle': './bin.js' }],
...
const EXECUTABLE_SOURCE_ALLOWLIST = new Map<string, string>([
  ...
  ['packages/bundle/bundle-builder/bin.js', 'public build-only wrapper'],
  ['packages/bundle/bundle-builder/src/bin.ts', 'public build-only implementation'],
