...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AgentHandle: 'core.md',
  AgentRuntimeProvider: 'core.md',
  AgentRuntimeProviderId: 'core.md',
  ...
  ResolvedRuntimeSubagentRoute: 'core.md',
  RuntimeCapacityLease: 'core.md',
  RuntimeProfileOverrides: 'core.md',
  RuntimeProfileSnapshot: 'core.md',
